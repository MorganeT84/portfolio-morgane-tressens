const techno = [
  ...
  },
  {
    ...
    description: "Christine Toledo est une thérapeute qui propose une thérapie pour le bien être psychique de ses patients.",
    objectifs: "La thérapeute a besoin de visibilité sur pour décrire son activité à de potentiels patients ainsi que les tarifs pratiqués. L'application permettra de contacter la thérapeute pour plus d'information ou la prise de rendez-vous. ",
    ...
    techno_back: [
      ...
      {
        id: 4,
        name: "xoauth2 > pour la sécurité de la boite mail gmail",
      }
    ],
    gestion: [
      {
    ...
    url: "www.therapeutechristinetoledo.fr"
  }
]
